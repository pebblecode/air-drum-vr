...
function getParam(name) {
    ...
    var x = results == null ? "" : decodeURIComponent(results[1].replace(/\+/g, " "));
    if (x)
      console.log("Got parameter: " + x);
    return x;
};
  ...
  window.controller = controller = new Leap.Controller({enableGestures: true});
